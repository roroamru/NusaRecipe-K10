...
$reseps = [
    ...
    [
        ...
        "kategori" => "makanan",
        "deskripsi" => "Ayam goreng krispi khas Nusantara dengan bumbu rempah sederhana seperti bawang putih, ketumbar, dan kunyit yang meresap hingga kedalam daging. Dibalut tepung berbumbu lalu digoreng hingga renyah keemasan, yang menghasilkan tekstur kriuk diluar juicy didalam. Cocok disajikan dengan sambal sebagai lauk makan siang atau malam bersama keluarga.",
        "waktu" => "± 30 menit",
        "porsi" => "3-4 orang",
        "bahan" => [
            "Bahan Utama" => [
    ...
    [
        ...
        "gambar" => "Es-Buah.jpg",
        "kategori" => "minuman",
        "deskripsi" => "Es buah segar khas Nusantara yang manis, dingin, dan menyegarkan. Perpaduan berbagai buah tropis seperti semangka, melon, dan nanas dipadukan dengan sirup manis serta es batu, menghasilkan minuman penutup yang cocok dinikmati saat cuaca panas atau sebagai hidangan santai bersama keluarga.",
        "waktu" => "± 15-20 menit",
        "porsi" => "3-4 orang",
        "bahan" => [
            "Bahan Utama" => [
    ...
    [
        ...
        "kategori" => "cemilan",
        "deskripsi" => "Gethuk lindri merupakan jajanan tradisional khas Indonesia yang dibuat dari singkong pilihan, diolah hingga lembut dan manis, lalu dibentuk cantik berwarna-warni. Ditambah taburan kelapa parut yang gurih, camilan ini menghadirkan perpaduan rasa klasik yang selalu bikin rindu.",
        "waktu" => "30 menit",
        "porsi" => "3-4 orang",
        "bahan" => [
            "Bahan Utama" => [
    ...
    [
        ...
        "gambar" => "Klepon.jpg",
        "kategori" => "cemilan",
        "deskripsi" => "Klepon adalah jajanan tradisional khas Nusantara yang terbuat dari tepung ketan dengan isian gula merah cair di dalamnya. Bertekstur kenyal dengan rasa manis yang meledak di mulut, serta dilapisi kelapa parut gurih, menjadikan klepon camilan klasik yang digemari banyak orang.",
        "waktu" => "30 menit",
        "porsi" => "3-4 orang",
        "bahan" => [
            "Bahan Adonan" => [
